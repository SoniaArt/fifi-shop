                    ...
                    <div class="accordion-body">
                        ...
                        <ol>
                            <li>
                                ...
                                <a href="mailto:support@fifi.com" class="form-link">support@fifi.com</a> 
                                с вашей почты, указанной в аккаунте, и укажите:
                                <ul type="disc" style="margin-top: 8px;">
                                    <li>номер заказа;</li>
                                    <li>артикул (ID) товара;</li>
                                    <li>причину возврата;</li>
                                    <li>фотографии товара (для подтверждения сохранности внешнего вида).</li>
                                </ul>
                                После этого ожидайте звонка оператора для получения накладной на бесплатный возврат посылки.
                            </li>
                            <li>После получения письма с подтверждением заполните отрывной бланк, полученный вместе с заказом, и вложите его в отправляемую посылку.</li>
                            <li>Обратитесь в пункт службы доставки — СДЭК, 5Post или Почты России — для отправки товара на адрес распределительного центра. При отправке Почтой России потребуется приобрести упаковочный пакет. Обратите внимание, что распечатывать возвратную накладную не требуется, достаточно назвать сотруднику ее номер.</li>
                            <li>После поступления посылки на склад FIFI нашими сотрудниками будет произведена проверка товарного вида изделий. При подтверждении сохранности внешнего вида будет выполнена одна из процедур ниже:
                                <ul type="disc">
