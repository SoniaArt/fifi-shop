    <footer class="container-fluid px-4">
        <div class="d-flex flex-wrap justify-content-around">
            <dl>
                <dt class="footer-title">ПОМОЩЬ</dt>
                <dd>
                    <a href="/FIFI/pages/payment.php" class="footer-link">Оплата</a>
                </dd>
                <dd>
                    <a href="/FIFI/pages/delivery.php" class="footer-link">Доставка</a>
                </dd>
                <dd>
                    <a href="/FIFI/pages/exchange_refund.php" class="footer-link">Возврат и обмен</a>
                </dd>
            </dl>
            <dl>
                <dt class="footer-title">КОМПАНИЯ</dt>
                <dd>
